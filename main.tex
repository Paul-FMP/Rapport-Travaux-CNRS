...
\begin{exemple}
	...
	Notons d'ailleurs que $X$ est un sous-groupe multiplicatif du corps différentiel ambiant.
\end{exemple}
...
Dans l'article \cite{Wang_2021}, je définis les notions suivantes:
...
\begin{itemize}
	\item Il existe une correspondance entre revêtements $1$-analysables sur $A$, uniformément finiment engendrés\footnote{Condition technique de finitude des langages des revêtements intermédiaires.}, localement stablement plongés\footnote{Condition technique de plongement stable de revêtements intermédiaires dans le revêtement global.}, et Delta groupoïdes sur $A$.
